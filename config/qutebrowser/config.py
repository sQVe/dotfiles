...
config.bind('zO', 'hint links spawn mimeo -q "{hint-url}"')
config.bind('zD', 'hint links spawn ~/scripts/qutebrowser/downloader.sh "{hint-url}"')
config.bind('zd', 'spawn ~/scripts/qutebrowser/downloader.sh "{url}"')
config.bind('zh', 'spawn term "http \"{url}\" --pretty=format | nvim"')
config.bind('zm', 'spawn mpv "{url}"')
config.bind('zo', 'spawn mimeo -q "{url}"')
