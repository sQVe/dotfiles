...
alias cfg-msmtprc='nvim-cd $HOME/.dotfiles/msmtprc'
alias cfg-mutt='nvim-cd $HOME/.dotfiles/config/mutt'
alias cfg-notmuch='nvim-cd $HOME/.dotfiles/notmuch'
alias cfg-nvim='nvim-cd $HOME/.dotfiles/config/nvim/'
alias cfg-offlineimaprc='nvim-cd $HOME/.dotfiles/offlineimaprc'
alias cfg-pam='nvim-cd $HOME/.dotfiles/pam_environment'
