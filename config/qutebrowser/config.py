...
config.bind('zS', 'hint links spawn term "cd ~/download; svtplay-dl \'{hint-url}\'"')
config.bind('zY', 'hint links spawn term "cd ~/download; youtube-dl \'{hint-url}\'"')
...
config.bind('zs', 'spawn term "cd ~/download; svtplay-dl \'{url}\'"')
config.bind('zy', 'spawn term "cd ~/download; youtube-dl \'{url}\'"')
