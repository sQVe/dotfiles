...
c.colors.completion.fg = '#4c4e5e'

# Background color of the completion widget for odd rows.
# Type: QssColor
c.colors.completion.odd.bg = '#f5f7fa'

# Background color of the completion widget for even rows.
# Type: QssColor
c.colors.completion.even.bg = '#e6e9ef'

# Foreground color of completion widget category headers.
# Type: QtColor
c.colors.completion.category.fg = '#5858a0'

# Background color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.bg = '#f5f7fa'

# Top border color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.border.top = '#f5f7fa'

# Bottom border color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.border.bottom = '#f5f7fa'

# Foreground color of the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.fg = '#f5f7fa'

# Background color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.bg = '#5858a0'

# Top border color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.border.top = '#5858a0'

# Bottom border color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.border.bottom = '#5858a0'

# Foreground color of the matched text in the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.match.fg = '#f5f7fa'

# Foreground color of the matched text in the completion.
# Type: QtColor
c.colors.completion.match.fg = '#a85820'

# Color of the scrollbar handle in the completion view.
# Type: QssColor
c.colors.completion.scrollbar.fg = '#4c4e5e'

# Color of the scrollbar in the completion view.
# Type: QssColor
c.colors.completion.scrollbar.bg = '#f5f7fa'

# Background color for the download bar.
# Type: QssColor
c.colors.downloads.bar.bg = '#f5f7fa'

# Color gradient start for download text.
# Type: QtColor
c.colors.downloads.start.fg = '#f5f7fa'

# Color gradient start for download backgrounds.
# Type: QtColor
c.colors.downloads.start.bg = '#5858a0'

# Color gradient end for download text.
# Type: QtColor
c.colors.downloads.stop.fg = '#f5f7fa'

# Color gradient stop for download backgrounds.
# Type: QtColor
c.colors.downloads.stop.bg = '#287028'

# Foreground color for downloads with errors.
# Type: QtColor
c.colors.downloads.error.fg = '#b82530'

# Font color for hints.
# Type: QssColor
c.colors.hints.fg = '#4c4e5e'

# Background color for hints. Note that you can use a `rgba(...)` value
# for transparency.
# Type: QssColor
c.colors.hints.bg = '#806010'

# Font color for the matched part of hints.
# Type: QtColor
c.colors.hints.match.fg = '#4c4e5e'

# Text color for the keyhint widget.
# Type: QssColor
c.colors.keyhint.fg = '#4c4e5e'

# Highlight color for keys to complete the current keychain.
# Type: QssColor
c.colors.keyhint.suffix.fg = '#5858a0'

# Background color of the keyhint widget.
# Type: QssColor
c.colors.keyhint.bg = '#f5f7fa'

# Foreground color of an error message.
# Type: QssColor
c.colors.messages.error.fg = '#f5f7fa'

# Background color of an error message.
# Type: QssColor
c.colors.messages.error.bg = '#b82530'

# Border color of an error message.
# Type: QssColor
c.colors.messages.error.border = '#b82530'

# Foreground color of a warning message.
# Type: QssColor
c.colors.messages.warning.fg = '#f5f7fa'

# Background color of a warning message.
# Type: QssColor
c.colors.messages.warning.bg = '#806010'

# Border color of a warning message.
# Type: QssColor
c.colors.messages.warning.border = '#806010'

# Foreground color of an info message.
# Type: QssColor
c.colors.messages.info.fg = '#4c4e5e'

# Background color of an info message.
# Type: QssColor
c.colors.messages.info.bg = '#f5f7fa'

# Border color of an info message.
# Type: QssColor
c.colors.messages.info.border = '#f5f7fa'

# Foreground color for prompts.
# Type: QssColor
c.colors.prompts.fg = '#4c4e5e'

# Border used around UI elements in prompts.
# Type: String
c.colors.prompts.border = '#f5f7fa'

# Background color for prompts.
# Type: QssColor
c.colors.prompts.bg = '#f5f7fa'

# Background color for the selected item in filename prompts.
# Type: QssColor
c.colors.prompts.selected.bg = '#bdbfc5'

# Foreground color of the statusbar.
# Type: QssColor
c.colors.statusbar.normal.fg = '#4c4e5e'

# Background color of the statusbar.
# Type: QssColor
c.colors.statusbar.normal.bg = '#f5f7fa'

# Foreground color of the statusbar in insert mode.
# Type: QssColor
c.colors.statusbar.insert.fg = '#287028'

# Background color of the statusbar in insert mode.
# Type: QssColor
c.colors.statusbar.insert.bg = '#f5f7fa'

# Foreground color of the statusbar in passthrough mode.
# Type: QssColor
c.colors.statusbar.passthrough.fg = '#806010'

# Background color of the statusbar in passthrough mode.
# Type: QssColor
c.colors.statusbar.passthrough.bg = '#f5f7fa'

# Foreground color of the statusbar in private browsing mode.
# Type: QssColor
c.colors.statusbar.private.fg = '#7c32a8'

# Background color of the statusbar in private browsing mode.
# Type: QssColor
c.colors.statusbar.private.bg = '#f5f7fa'

# Foreground color of the statusbar in command mode.
# Type: QssColor
c.colors.statusbar.command.fg = '#5858a0'

# Background color of the statusbar in command mode.
# Type: QssColor
c.colors.statusbar.command.bg = '#f5f7fa'

# Foreground color of the statusbar in private browsing + command mode.
# Type: QssColor
c.colors.statusbar.command.private.fg = '#7c32a8'

# Background color of the statusbar in private browsing + command mode.
# Type: QssColor
c.colors.statusbar.command.private.bg = '#e6e9ef'

# Foreground color of the statusbar in caret mode.
# Type: QssColor
c.colors.statusbar.caret.fg = '#5858a0'

# Background color of the statusbar in caret mode.
# Type: QssColor
c.colors.statusbar.caret.bg = '#f5f7fa'

# Foreground color of the statusbar in caret mode with a selection.
# Type: QssColor
c.colors.statusbar.caret.selection.fg = '#5858a0'

# Background color of the statusbar in caret mode with a selection.
# Type: QssColor
c.colors.statusbar.caret.selection.bg = '#f5f7fa'

# Background color of the progress bar.
# Type: QssColor
c.colors.statusbar.progress.bg = '#5858a0'

# Default foreground color of the URL in the statusbar.
# Type: QssColor
c.colors.statusbar.url.fg = '#4c4e5e'

# Foreground color of the URL in the statusbar on error.
# Type: QssColor
c.colors.statusbar.url.error.fg = '#b82530'

# Foreground color of the URL in the statusbar for hovered links.
# Type: QssColor
c.colors.statusbar.url.hover.fg = '#a85820'

# Foreground color of the URL in the statusbar on successful load
# (http).
# Type: QssColor
c.colors.statusbar.url.success.http.fg = '#287028'

# Foreground color of the URL in the statusbar on successful load
# (https).
# Type: QssColor
c.colors.statusbar.url.success.https.fg = '#287028'

# Foreground color of the URL in the statusbar when there's a warning.
# Type: QssColor
c.colors.statusbar.url.warn.fg = '#806010'

# Background color of the tab bar.
# Type: QssColor
c.colors.tabs.bar.bg = '#f5f7fa'

# Color gradient start for the tab indicator.
# Type: QtColor
c.colors.tabs.indicator.start = '#5858a0'

# Color gradient end for the tab indicator.
# Type: QtColor
c.colors.tabs.indicator.stop = '#287028'

# Color for the tab indicator on errors.
# Type: QtColor
c.colors.tabs.indicator.error = '#b82530'

# Foreground color of unselected odd tabs.
# Type: QtColor
c.colors.tabs.odd.fg = '#5858a0'

# Background color of unselected odd tabs.
# Type: QtColor
c.colors.tabs.odd.bg = '#dce0e8'

# Foreground color of unselected even tabs.
# Type: QtColor
c.colors.tabs.even.fg = '#5858a0'

# Background color of unselected even tabs.
# Type: QtColor
c.colors.tabs.even.bg = '#dce0e8'

# Foreground color of selected odd tabs.
# Type: QtColor
c.colors.tabs.selected.odd.fg = '#4c4e5e'

# Background color of selected odd tabs.
# Type: QtColor
c.colors.tabs.selected.odd.bg = '#eff1f5'

# Foreground color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.fg = '#4c4e5e'

# Background color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.bg = '#eff1f5'

# Foreground color of pinned unselected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.odd.fg = '#f5f7fa'

# Background color of pinned unselected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.odd.bg = '#e6e9ef'

# Foreground color of pinned unselected even tabs.
# Type: QtColor
c.colors.tabs.pinned.even.fg = '#f5f7fa'

# Background color of pinned unselected even tabs.
# Type: QtColor
c.colors.tabs.pinned.even.bg = '#5858a0'

# Foreground color of pinned selected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.odd.fg = '#4c4e5e'

# Background color of pinned selected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.odd.bg = '#e6e9ef'

# Foreground color of pinned selected even tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.even.fg = '#4c4e5e'

# Background color of pinned selected even tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.even.bg = '#e6e9ef'

# Background color for webpages if unset (or empty to use the theme's
# color).
# Type: QtColor
c.colors.webpage.bg = '#f5f7fa'
