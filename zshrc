...
alias cfg-ergodox-keymap='nvim-pwd $HOME/code/qmk_firmware/keyboards/ergodox_ez/keymaps/sqve'
...
alias cfg-preonic-keymap='nvim-pwd $HOME/code/qmk_firmware/keyboards/preonic/keymaps/sqve'
