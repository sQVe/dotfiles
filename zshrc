...
alias cfg-keymap-ergodox='nvim-pwd $HOME/code/qmk_firmware/keyboards/ergodox_ez/keymaps/sqve/keymap.c'
alias cfg-keymap-preonic='nvim-pwd $HOME/code/qmk_firmware/keyboards/preonic/keymaps/sqve/keymap.c'
